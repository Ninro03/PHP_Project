...
<?php
	if(!$userid) {
?>
				<li><a href="member_form.php">회원 가입(11Ch)</a></li>
				<li> | </li>
				<li><a href="login_form.php">로그인(12Ch)</a></li>
<?php
	} else {
...
?>
				<li><?=$logged?></li>
				<li> | </li>
				<li><a href="logout.php">로그아웃(12Ch)</a></li>
				<li> | </li>
...
?>
		...
		<div id="menu_bar">
			<ul>
				...
				<li><a href="message_form.php">쪽지 만들기(13Ch)</a></li>
				<li><a href="board_form.php">게시판 만들기(14Ch)</a></li>
